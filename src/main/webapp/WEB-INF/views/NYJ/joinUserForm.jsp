	...
	<body>
		...
		<form id="joinUserForm" name="joinUserForm" action="mb_Join" method="post">
			<table name="table" id="tables">
				<tr>
					<td>이름</td>
					<td colspan="6"><input type="text" name="m_name" id="m_name"/><br/>
					<font name="joinName"></font></td>
				 </tr>
	                
				<tr>
					<td>아이디</td>
					<td colspan="6"><input type="text" name="m_id" id="m_id"/><br/>
				...
				<tr>
					<td>비밀번호</td>
					<td colspan="6"><input type="password" name="m_pw" id="m_pw"><br/>
					<font name="joinPw"></font></td>
				</tr>
				
				<tr>
					<td>비밀번호 확인</td>
					<td colspan="6"><input type="password" name="m_pwConfirm" id="m_pwConfirm"><br/>
					<font name="joinPwc"></font></td>
				</tr>
				
				<tr>
					<td>성별</td>
					<td colspan="5"><div style="width:50%;float:left;">
						<input type="radio" name="m_gender" checked="checked" value="남자" style="margin:5px;">&nbsp;&nbsp;남자</div>
					<div><input type="radio" name="m_gender" value="여자" style="margin:5px;">&nbsp;&nbsp;여자</div></td>
				 </tr>
				 
				 <tr>
					<td>핸드폰 번호</td>
					<td colspan="6"><input type="text" name="m_phone" id="m_phone"><br/>
				...
				<tr>
					<td>생년월일</td>
					<td>
						<select id="m_year" name="m_year" class="birth">
					...
					<td>
						<select id="m_month" name="m_month" class="birth">
					...
					<td>
						<select id="m_day" name="m_day" class="birth">
				...
				<tr>
					<td>이메일</td>
					<td colspan="6"><input type="text" name="m_email" id="m_email"><br/>
				...
				<tr>
					<td>관심분야</td>
					<td colspan="6"><div class="checks"><input type="checkbox" name="ch_check" value="1">&nbsp;&nbsp;도서</div>
					<div class="checks"><input type="checkbox" name="ch_check" value="2">&nbsp;&nbsp;영화</div>
					<div class="checks"><input type="checkbox" name="ch_check" value="3">&nbsp;&nbsp;음악</div>
					<div class="checks"><input type="checkbox" name="ch_check" value="4">&nbsp;&nbsp;공예</div>
					<div class="checks"><input type="checkbox" name="ch_check" value="5">&nbsp;&nbsp;사진</div>
					<div class="checks"><input type="checkbox" name="ch_check" value="6">&nbsp;&nbsp;운동</div>
					<div class="checks"><input type="checkbox" name="ch_check" value="7">&nbsp;&nbsp;기타</div></td>
				</tr>
			</table>
			...
			<!-- 소수의 취향 이용약관 -->
				...
				<div id="eb_two">
					...
					<input class="openMenu2 eb_btn" type="button" value="이용약관 보기"/>
						...
						<div id="here2" style="display:none;height: 200px;overflow: auto;">
							<p>
				...
				<div id="eb_three">
					...
					<input class="openMenu3 eb_btn" type="button" value="이용약관 보기"/>
						...
						<div id="here3" style="display:none;height: 200px;overflow: auto;">
